      ...
      .mutation(async ({ ctx, input }) => {
        try {
          ...
          const report = await db.createVerificationReport({
            ...
            metadataFindings: result.metadata.details,
            visionFindings: result.vision.details,
            weatherFindings: result.weather.details,
            evidenceFindings: result.evidence.details,
