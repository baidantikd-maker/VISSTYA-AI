      ...
      <div className="relative">
        ...
        <div className="mt-3 flex flex-wrap items-center justify-between gap-2">
          <p className="truncate text-xs text-[hsl(var(--muted))]">
            {value.fileName ?? t("report.mediaFromUrl")} · {value.kind}
          </p>
          <button
            type="button"
    ...
    <div>
      ...
      >
        ...
        <p className="mt-4 text-sm font-medium text-[hsl(var(--foreground))]">
          {t("upload.dropPrefix")}<span className="underline underline-offset-4">{t("upload.browse")}</span>
        </p>
      ...
      <div className="mt-3 flex items-center gap-3">
        ...
        <span className="text-xs text-[hsl(var(--muted))]">{t("common.or")}</span>
        <div className="h-px flex-1 bg-[hsl(var(--border))]" />
      </div>
